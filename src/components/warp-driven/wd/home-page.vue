<template>
  <div class="home-page">
    <el-container>
      <el-aside><i class="logo-img"></i>Warp Driven</el-aside
      ><el-main
        >Welcome to Warp Driven Technology, we contribute your eCommerce
    ...
    <el-row>
      ...
      >
        ...
        >
          ...
          <template #extra>
            <el-link
              href="https://warp-driven.com/my-account/"
              target="_blank"
    ...
    <optimize-page
      v-show="authenticated && !is_expired"
      @task-status="loadTaskStatus"
    ></optimize-page>
...
export default {
  ...
  components: { optimizePage, WarpDrivenVsRegister, User, Key, Setting },
  methods: {
