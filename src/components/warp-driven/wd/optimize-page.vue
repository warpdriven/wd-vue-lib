      ...
      <el-col :span="16">
        ...
        <el-row>
          ...
          <el-col :span="12">
            ...
            ></el-progress>
            <br />
            <el-checkbox v-model="remove"
              >Remove pictrue background</el-checkbox
            >
          </el-col>
        </el-row>
      </el-col>
    ...
    <el-row>
      ...
      <el-col :span="22">
        <el-button
          ...
          :loading="loading"
          :disabled="disabled"
          >Start Bulk Optimization</el-button
        >
      </el-col>
    </el-row>
    <el-row>
  ...
  computed: {
    disabled() {
      return (
        ...
        this.image_vector_left < 1
      );
    },
    ivpercentage() {
      return this.image_vector_plan === 0
        ? 0
